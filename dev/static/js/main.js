...
$(document).ready(function () {
    // Begin open/close navigation
    var hamburger = $('#hamburger'),
        modalNav = $('#modalNav'),
        modalNavClose = $('#modalNavClose');

    $(hamburger).click( function() {
        $(modalNav).toggleClass('active');
    });

    $(modalNavClose).add(modalNav).click( function() {
        $(modalNav).removeClass('active');
    });
    // End open/close navigation

    // Begin change request communication tabs
    $('.reqCom').click( function() {
        $('.reqCom').each( function() {
            $(this).removeClass('active');
        })

        $(this).addClass('active');
    });
    // End change request communication tabs
    ...
    var freeAdmissionBtn = $('#freeAdmissionBtn'),
        freeAdmissionModal = $('#freeAdmission'),
        closeModal = $('.modal-request__close');

        $(freeAdmissionBtn).click( function(e) {
            e.stopPropagation();

            $(freeAdmissionModal).fadeIn();
        });
